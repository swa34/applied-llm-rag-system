...
| 4. Infrastructure | Add the runtime, dependency, and reliability support the demo needs | Complete | Pinned Node runtime, no third-party npm dependencies, configuration checks, 57 passing offline tests, and successful hosted CI; see the [verification record](docs/LOCAL_DEMO.md#phase-4-local-verification) |
