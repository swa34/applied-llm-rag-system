...
| Reproducible infrastructure | `.nvmrc`, runtime/configuration preflight, and credential-free GitHub Actions workflow | 57 offline tests passed locally and in hosted CI on the pinned runtime; see the [verification record](LOCAL_DEMO.md#phase-4-local-verification) |
