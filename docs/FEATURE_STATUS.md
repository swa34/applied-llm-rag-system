...
| Reproducible infrastructure | `.nvmrc`, runtime/configuration preflight, and credential-free GitHub Actions workflow | 58 offline tests pass locally on the pinned runtime; hosted runs and earlier counts are recorded in the [verification record](LOCAL_DEMO.md#phase-4-local-verification) |
