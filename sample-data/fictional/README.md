...
“Held out” does not mean secret: this is a public repository. It means the evaluation cases were structurally separate and were not used to revise prompts, retrieval, or scoring rules before the Phase 6 freeze. The [Phase 6 result](../../evaluation/fictional/v1/results/phase-6/README.md) binds six runs to the frozen corpus, suites, prompt/configuration, repository revision, and source hashes. Those outcomes are now exposed. If any result is used for tuning, the case becomes a development regression and a new evaluation case is required.
